...
G1 <- ggplot() + 
  ...
  geom_segment(data=rE4swide, aes(x=1-.15, y=rE4swide$LowLoad_Incongruent, 
                                    xend=1+.15, yend=rE4swide$LowLoad_Congruent),
               color="gray80") +
  geom_segment(data=rE4swide, aes(x=2-.15, y=rE4swide$HighLoad_Incongruent, 
                                    xend=2+.15, yend=rE4swide$HighLoad_Congruent),
               color="gray80") +
...
G2 <- ggplot(rE4CEslong, aes(x=PercLoad, y=cEffect)) +
  ...
  geom_segment(data=rE4CEswide, color="gray80", 
               aes(x=1, y=rE4CEswide$LowLoad, xend=2, yend=rE4CEswide$HighLoad)) +
