...
G1 <- ggplot() + 
  ...
  geom_segment(data=rE3swide, aes(x=1-.15, y=rE3swide$LowLoad_Incongruent, 
                                    xend=1+.15, yend=rE3swide$LowLoad_Congruent),
               color="gray80") +
  geom_segment(data=rE3swide, aes(x=2-.15, y=rE3swide$HighLoad_Incongruent, 
                                    xend=2+.15, yend=rE3swide$HighLoad_Congruent),
               color="gray80") +
...
G2 <- ggplot(rE3CEslong, aes(x=vstmLoad, y=cEffect)) +
  ...
  geom_segment(data=rE3CEswide, color="gray80", 
               aes(x=1, y=rE3CEswide$LowLoad, xend=2, yend=rE3CEswide$HighLoad)) +
